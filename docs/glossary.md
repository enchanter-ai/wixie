...
The full rationale lives in [shared/conduct/formatting.md](../shared/conduct/formatting.md).
...
Failure codes (F01–F14) are defined in [shared/conduct/failure-modes.md](../shared/conduct/failure-modes.md).
