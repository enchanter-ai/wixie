...
| `models-registry.json` | `wixie/shared/` | 447 models, capability profiles. Every tier-routing decision starts here. |
...
- **wixie** — Prompt engineering runtime. The most complete plugin. Inference engine + 7-stage skill pipeline + 447-model registry
...
447 models, dated 2026-08-07. With current model release cadence the registry drifts within weeks. Need an automated update contract — manual `last_updated` bumps don't scale.
