...
<p>
  ...
  <img alt="447 models" src="https://img.shields.io/badge/Models-447-58a6ff?style=for-the-badge">
...
**6 plugins. 7 agents. 447 models. Gauss Convergence Method. One command.**
...
- [6 Plugins, 7 Agents, 447 Models](#6-plugins-7-agents-447-models)
...
Wixie doesn't generate prompts. It **engineers** them — then stress-tests, hardens, and translates them across 447 models.
...
**447 models** across text, code, image, video, and audio. Not just the big 3.
...
| prompt-translate | `/translate-prompt` | Converts between 447 models | adapter (Sonnet) |
...
The **PDF audit report** includes: quality score bars, 8 binary assertion results, technique pills, model profile from the 447-model registry, prompt statistics, audit findings (CRITICAL/WARNING), cost estimate, and an honest verdict with next steps.
...
Constraint-preserving prompt transformation across 447 models. Composition of format converter, technique selector, and model adapter.
...
|---|---|---|---|---|---|
| Create prompts | 16 techniques, 447 models | - | - | - | trial and error |
...
| Translate prompts | 447 models, auto-adapted | - | - | - | manual rewrite |
