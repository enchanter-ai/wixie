...
Give it a task description. It scans your project context, asks targeted questions, selects from 16 techniques, adapts format to 447 models, then runs the Convergence Engine autonomously until the prompt hits DEPLOY quality.
