...
Governed by `@../foundations/packages/web/conduct/web-fetch.md` (caching, tier selection, cite hygiene) and `@../foundations/packages/core/conduct/tier-sizing.md` (this prompt's density is intentional — do not skim).
